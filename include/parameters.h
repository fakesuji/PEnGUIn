...
const double frame_omega = 1.0;//42.5872131567;

const double sav_interval = 100.0*twopi/frame_omega;
const double end_time = 500.0*twopi/frame_omega;
...
const double beta_cool = 100.0;                          // in units of dynamical time for beta cooling
...
const double planet_mass = 0.001;//0.0123;
const double planet_radius = 1.0;

const double ramp_time = 5.0*twopi;
