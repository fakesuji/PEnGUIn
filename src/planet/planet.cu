...
/*
__global__ void accretion(Grid G, Cell* C, double dt)
{
...
void planet_accretion(Grid* dev, double dt)
{
	int nx, ny, nz;
	for (int n=0; n<ndev; n++)
	{
		...
		accretion<<< dim3(nx/x_xdiv,ny/x_ydiv,nz/x_zdiv), dim3(x_xdiv,x_ydiv,x_zdiv), 0, dev[n].stream >>> (dev[n],dev[n].C,dt);
	}
	return;
}
*/
